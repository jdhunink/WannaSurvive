...
echo "$2"
#print start message
echo "Backing up $backup_files to $newDest/backups/$archive_file"

#backup files
tar czf $newDest/backups/$archive_file $backup_files
